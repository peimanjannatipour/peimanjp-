...
const statusStyles: Record<string, string> = {
  ...
  "Manuscript in preparation": "border-slate-200 bg-slate-50 text-slate-700",
  ...
  "Research line": "border-blue-200 bg-blue-50 text-blue-800",
  ...
  "Affiliation to verify": "border-slate-200 bg-slate-50 text-slate-700",
